...
export const site = {
  name: "妈薯",
  desc: "随缘发布",
  url: "https://blog.enkansakura.top",
  avatar: "https://weavatar.com/avatar/cc12d64d705412a62cc743395da2ed1e6dfcf0ab2854cd88e33a50bc6a7450dd?s=640",
  issues: "https://github.com/EnkanSakura/Firefly/issues"
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">评论区留言/在Repo中提 <a class="link font-semibold text-sm mb-1" target="_blank" href={site.issues}>Issue</a> ：</p>
