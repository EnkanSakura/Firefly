...
export const en: Translation = {
	...
	// Dota2 Match Record
	[Key.dota2]: "Dota2",
	[Key.dota2Title]: "Dota2 Match Record",
	[Key.dota2Subtitle]: "Dota2 match history, data from Stratz API",
	[Key.dota2LastUpdated]: "Data updated at",
	[Key.dota2NotConfigured]: "Dota2 Not Configured",
	[Key.dota2NotConfiguredDesc]: "Please set your Steam Player ID in src/config/siteConfig.ts and API Token via STRATZ_API_KEY environment variable",
	[Key.dota2FetchError]: "Failed to fetch match data",
	[Key.dota2FetchErrorDesc]: "Please check your API Token and network connection",
	[Key.dota2Empty]: "No match data",
	[Key.dota2EmptyReason]: "No available match records for this account",
	[Key.dota2MatchId]: "Match ID",
	[Key.dota2Position]: "Position",
	[Key.dota2Result]: "Result",
	[Key.dota2Win]: "Win",
	[Key.dota2Loss]: "Loss",
	[Key.dota2KDA]: "K/D/A",
	[Key.dota2DateTime]: "Date",
	[Key.dota2Duration]: "Duration",
	[Key.dota2Hero]: "Hero",
	[Key.dota2NetWorth]: "Net Worth",
	[Key.dota2ConfigTip]: "Set Steam Player ID in site config and API Token via STRATZ_API_KEY env variable",
