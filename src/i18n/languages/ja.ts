...
export const ja: Translation = {
	...
	// Dota2 マッチ記録
	[Key.dota2]: "Dota2",
	[Key.dota2Title]: "Dota2 マッチ記録",
	[Key.dota2Subtitle]: "Dota2 マッチ履歴、Stratz API からデータ取得",
	[Key.dota2LastUpdated]: "データ更新",
	[Key.dota2NotConfigured]: "Dota2 未設定",
	[Key.dota2NotConfiguredDesc]: "src/config/siteConfig.ts で Steam プレイヤーID と Stratz API トークンを設定してください",
	[Key.dota2FetchError]: "マッチデータの取得に失敗しました",
	[Key.dota2FetchErrorDesc]: "API トークンとネットワーク接続を確認してください",
	[Key.dota2Empty]: "マッチデータなし",
	[Key.dota2EmptyReason]: "このアカウントには利用可能なマッチ記録がありません",
	[Key.dota2MatchId]: "マッチID",
	[Key.dota2Position]: "ポジション",
	[Key.dota2Result]: "結果",
	[Key.dota2Win]: "勝利",
	[Key.dota2Loss]: "敗北",
	[Key.dota2KDA]: "K/D/A",
	[Key.dota2DateTime]: "日時",
	[Key.dota2Duration]: "時間",
	[Key.dota2Hero]: "ヒーロー",
	[Key.dota2NetWorth]: "ネットワース",
	[Key.dota2ConfigTip]: "サイト設定で Steam プレイヤーID と Stratz API トークンを入力してください",
