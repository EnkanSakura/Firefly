...
export const zh_TW: Translation = {
	...
	// Dota2 比賽記錄
	[Key.dota2]: "Dota2",
	[Key.dota2Title]: "Dota2 比賽記錄",
	[Key.dota2Subtitle]: "Dota2 比賽歷史記錄，數據來自 Stratz API",
	[Key.dota2LastUpdated]: "數據更新於",
	[Key.dota2NotConfigured]: "未配置 Dota2",
	[Key.dota2NotConfiguredDesc]: "請在 src/config/siteConfig.ts 中配置你的 Steam Player ID 和 Stratz API Token",
	[Key.dota2FetchError]: "獲取比賽數據失敗",
	[Key.dota2FetchErrorDesc]: "請檢查 API Token 和網絡連接是否正確",
	[Key.dota2Empty]: "暫無比賽數據",
	[Key.dota2EmptyReason]: "該帳號暫無可用的比賽記錄",
	[Key.dota2MatchId]: "比賽ID",
	[Key.dota2Position]: "位置",
	[Key.dota2Result]: "結果",
	[Key.dota2Win]: "勝利",
	[Key.dota2Loss]: "失敗",
	[Key.dota2KDA]: "K/D/A",
	[Key.dota2DateTime]: "比賽時間",
	[Key.dota2Duration]: "時長",
	[Key.dota2Hero]: "英雄",
	[Key.dota2NetWorth]: "經濟",
	[Key.dota2ConfigTip]: "在站點配置中填寫你的 Steam Player ID 和 Stratz API Token",
