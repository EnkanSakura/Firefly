...
export const zh_CN: Translation = {
	...
	// Dota2 比赛记录
	[Key.dota2]: "Dota2",
	[Key.dota2Title]: "Dota2 比赛记录",
	[Key.dota2Subtitle]: "Dota2 比赛历史记录，数据来自 Stratz API",
	[Key.dota2LastUpdated]: "数据更新于",
	[Key.dota2NotConfigured]: "未配置 Dota2",
	[Key.dota2NotConfiguredDesc]: "请在 src/config/siteConfig.ts 中配置 Steam Player ID，并通过环境变量 STRATZ_API_KEY 设置 API Token",
	[Key.dota2FetchError]: "获取比赛数据失败",
	[Key.dota2FetchErrorDesc]: "请检查 API Token 和网络连接是否正确",
	[Key.dota2Empty]: "暂无比赛数据",
	[Key.dota2EmptyReason]: "该账号暂无可用的比赛记录",
	[Key.dota2MatchId]: "比赛ID",
	[Key.dota2Position]: "位置",
	[Key.dota2Result]: "结果",
	[Key.dota2Win]: "胜利",
	[Key.dota2Loss]: "失败",
	[Key.dota2KDA]: "K/D/A",
	[Key.dota2DateTime]: "比赛时间",
	[Key.dota2Duration]: "时长",
	[Key.dota2Hero]: "英雄",
	[Key.dota2NetWorth]: "经济",
	[Key.dota2ConfigTip]: "在站点配置中填写 Steam Player ID，并通过环境变量 STRATZ_API_KEY 设置 API Token",
