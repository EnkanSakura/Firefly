...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/aoihoshi1.avif",
			"assets/images/DesktopWallpaper/aoihoshi2.avif",
			"assets/images/DesktopWallpaper/kamiina1.avif",
			"assets/images/DesktopWallpaper/kamiina2.avif",
			"assets/images/DesktopWallpaper/futariheya1.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/sasakoi1.avif",
			"assets/images/MobileWallpaper/sasakoi2.avif",
			"assets/images/MobileWallpaper/sasakoi3.avif",
			"assets/images/MobileWallpaper/odoruba1.avif",
			"assets/images/MobileWallpaper/yagakimi1.avif",
		],
		// 背景视频播放地址
